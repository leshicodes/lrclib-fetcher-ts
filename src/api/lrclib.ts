    ...
    try {
      ...
      if (metadata.duration) {
        try {
          ...
          console.log("Trying exact match with:", exactParams);
      ...
      console.log("Trying search with:", searchParams);
      ...
      if (!response.data || response.data.length === 0) {
        ...
        console.log("Trying fallback search with:", fallbackParams);
      ...
      console.error(`Error fetching lyrics for ${metadata.artist} - ${metadata.title}:`, error);
